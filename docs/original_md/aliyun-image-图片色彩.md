Title: 通过调整图片亮度、对比度和锐化强度校正颜色偏差、提升清晰度_CDN(CDN)-阿里云帮助中心

URL Source: https://help.aliyun.com/zh/cdn/user-guide/change-the-color-of-an-image

Markdown Content:
通过调整图片亮度、对比度和锐化强度校正颜色偏差、提升清晰度_CDN(CDN)-阿里云帮助中心
...
[首页](https://help.aliyun.com/)[CDN](https://help.aliyun.com/zh/cdn/)[操作指南](https://help.aliyun.com/zh/cdn/user-guide/)[域名管理](https://help.aliyun.com/zh/cdn/user-guide/domain-name-management/)[性能优化](https://help.aliyun.com/zh/cdn/user-guide/performance-optimization/)[图像处理](https://help.aliyun.com/zh/cdn/user-guide/image-editing/)图片色彩

图片色彩
====

更新时间：2024-03-26 07:08:27

[产品详情](https://www.aliyun.com/product/cdn)

[我的收藏](https://help.aliyun.com/my_favorites.html)

当图片因为相机设置或设备差异而呈现出颜色不准确、图像模糊时，可以通过调整 CDN 上原图亮度、对比度修正图片色彩；调整图片锐化强度，提升图片清晰度和视觉效果。
...
*   取值＞0：提高图片对比度。
sharpen 设置图片锐化效果的强度。[50,399]

取值越大，图片越清晰，但过大的值可能会导致图片失真。推荐您使用 50、100、150、200、250 和 300 这六个锐化值。

操作示例
----

*   对原图进行锐化处理，锐化参数为 100，图片处理 URL 为：`http(s)://example.com/image01.png?image_process=sharpen,100`

*   将图片亮度提高 50，图片处理 URL 为：`http(s)://example.com/image01.png?image_process=bright,50`

*   对比度降低 50，图片处理 URL 为：`http(s)://example.com/image01.png?image_process=contrast,50`

[上一篇：图片旋转](https://help.aliyun.com/zh/cdn/user-guide/rotate-images)[下一篇：添加水印](https://help.aliyun.com/zh/cdn/user-guide/manage-image-watermarks)
